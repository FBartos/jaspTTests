...
Section
{
	...
	property alias nonlocalPriorsEnabled: nonlocalPriors.enabled
	property alias defaultPriorsChecked: defaultPriors.checked
	property alias nonlocalPriorsChecked: nonlocalPriors.checked
	property alias nonlocalMomentBFFChecked: nonlocalMomentBFF.checked
	...
	RadioButtonGroup
	{
		...
		RadioButtonGroup
		{
			...
			{
                id: nonlocalPriors
				label: qsTr("Nonlocal"); name: "nonlocal"

				RadioButtonGroup
				{
					name: "nonlocalStandardizedEffectSize"
					RadioButton
					{
						label: qsTr("Moment (Bayes Factor Function)"); name: "momentBFF"; checked: true; childrenOnSameRow: true; id: nonlocalMomentBFF
						DoubleField { label: qsTr("r:"); name: "nonlocalMomentBFFR"; visible: nonlocalMomentBFF.checked; defaultValue: 1; min: 1; max: 20; inclusive: JASP.MinOnly }
					}
					RadioButton
					{
